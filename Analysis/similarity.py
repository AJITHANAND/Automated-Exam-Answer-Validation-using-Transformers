...
Original file is located at
    https://colab.research.google.com/drive/1gTgKreJ2QK074WURoUoaCNk1MCUbHd4s
"""
...
def analysis(answer:str):
    ...
    for doc in data['text']:
        ...
        filtered_tokens = [word for word, pos in tagged_tokens if word not in stop_words and pos != 'IN' and word not in punctuation]
        # Stemming
